...
public class ConversionDomainService {
    ...
    private KrDataIndex handleKeyboardChar(StringBuilder res, Integer engPosition, KrDataIndex indexInfo, char engCh) {
    ...
    private KrDataIndex useJongsungToChosungForJungsung(final KrDataIndex indexInfo, StringBuilder res) {
        ...
        String separated =
                KeyboardIndex.SEPARATED_CONSONANT_MAP.get(KeyboardIndex.JONG_DATA.charAt(indexInfo.jongsung()));
